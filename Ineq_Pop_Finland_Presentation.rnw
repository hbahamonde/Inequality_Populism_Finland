...
\begin{frame}[c]%{Thank you}
      \begin{centering}
        \begin{itemize}
            ...
            \item[] {\huge The literature is not in a good shape.} 
        \end{itemize}
        \end{centering}
\end{frame}
...
\begin{column}[T]{0.55\textwidth}
    \begin{minipage}[c][.6\textheight][c]{\linewidth}
        \begin{itemize}
            ...
            \item {\bf Our interpretation}: \emph{Given that individuals prioritize preventing economic decline, they perceive the potential losses associated with skilled immigrants in contexts characterized by high inequality}.
        \end{itemize} 
    \end{minipage}
\end{column}
